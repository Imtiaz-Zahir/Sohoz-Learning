  ...
  return (
    ...
    <section className="w-full py-20 px-0 xs:px-2 sm:px-6 lg:px-20 mt-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-cyan-50">
        <div className="text-center">
            ...
            <div id="div1" className="px-6 py-4 my-3 transition-all overflow-hidden h-16 bg-white rounded-xl duration-500">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">How can I get the course certificate?</h1>
                    <i id="plus1" onclick="work('plus1')" className="uil uil-plus text-2xl cursor-pointer text-orange-500"></i>
                    <i id="minus1" onclick="work('minus1')" className="uil uil-minus hidden cursor-pointer text-2xl text-orange-500"></i>
                </div>
                <p className="text-lg">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque
                    volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper
                    suscipit.</p>
            </div>
            <div id="div2" className="px-6 py-4 my-3 transition-all overflow-hidden h-16 bg-white rounded-xl duration-500">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">How can I get the course certificate?</h1>
                    <i id="plus2" onclick="work('plus2')" className="uil uil-plus text-2xl cursor-pointer text-orange-500"></i>
                    <i id="minus2" onclick="work('minus2')" className="uil uil-minus hidden cursor-pointer text-2xl text-orange-500"></i>
                </div>
                <p className="text-lg">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque
                    volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper
                    suscipit.</p>
            </div>
            <div id="div3" className="px-6 py-4 my-3 transition-all overflow-hidden h-16 bg-white rounded-xl duration-500">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">How can I get the course certificate?</h1>
                    <i id="plus3" onclick="work('plus3')" className="uil uil-plus text-2xl cursor-pointer text-orange-500"></i>
                    <i id="minus3" onclick="work('minus3')" className="uil uil-minus hidden cursor-pointer text-2xl text-orange-500"></i>
                </div>
                <p className="text-lg">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque
                    volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper
                    suscipit.</p>
            </div>
            <div id="div4" className="px-6 py-4 my-3 transition-all overflow-hidden h-16 bg-white rounded-xl duration-500">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">How can I get the course certificate?</h1>
                    <i id="plus4" onclick="work('plus4')" className="uil uil-plus text-2xl cursor-pointer text-orange-500"></i>
                    <i id="minus4" onclick="work('minus4')" className="uil uil-minus hidden cursor-pointer text-2xl text-orange-500"></i>
                </div>
                <p className="text-lg">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque
                    volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper
                    suscipit.</p>
