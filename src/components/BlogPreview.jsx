...
export default function BlogPreview() {
    return (
        <div className="mb-10">
            ...
            <Link to="/blog" className="text-3xl font-bold hover:text-orange-500">Learn Webs Applications Development from Experts</Link>
            ...
            <Link to="/blog" className="uppercase py-4 px-8 bg-orange-600 hover:bg-blue-900 text-white font-bold rounded-md">read more</Link>
        </div>
    )
}
