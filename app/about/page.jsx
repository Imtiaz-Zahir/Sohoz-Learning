...
export default function page() {
  return (
    ...
    <section className="px-0 xs:px-2 sm:px-6 lg:px-32 py-20 grid grid-cols-1 justify-center gap-6 lg:grid-cols-3">
        <img className="rounded-2xl mt-28 hidden lg:block" src="/about-img-1.jpg" alt=""/>
        <img className="rounded-2xl w-full" src="/img-lg-2.jpg" alt=""/>
        <img className="rounded-2xl mt-28 hidden lg:block" src="/about-img-3.jpg" alt=""/>
    </section>
