...
import { UilLocationPinAlt,UilEnvelopeAlt,UilPhoneVolume } from '@iconscout/react-unicons';
  ...
  return (
    <footer className="w-full bg-[#0e0a38] px-0 xs:px-2 sm:px-6 lg:px-12 text-white text-xl font-bold">
        <div className="py-20 lg:flex">
            <div className="px-6">
                <img className="h-10" src="/logo-white.png" alt=""/>
            ...
            <div className="w-full rounded-xl px-6">
                ...
                <div className="flex items-center">
                    <img className="h-24 w-24 rounded-md" src="/blog-5-1200x600.jpg" alt=""/>
                    <div className="p-4">
