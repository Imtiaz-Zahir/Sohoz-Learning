...
export default function WebinarPreview() {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 p-6 items-center rounded-xl web">
            ...
            <div>
                <Link className="hover:text-orange-500" href="/webinar"><h2 className="text-2xl font-bold">Web Programming Career Guideline</h2></Link>
                ...
                <Link href="/webinar"><div className="border-orange-500 border hover:bg-orange-500 hover:text-white font-bold text-xl text-orange-500 text-center py-2 w-36 rounded-md my-4">Read More</div></Link>
            </div>
        </div>
    )
}
