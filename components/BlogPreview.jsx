...
export default function BlogPreview({ data ,key }) {
    return (
        <div key={key} className="mb-10">
            <Image className="w-full rounded-xl" height={370} width={750} src={`/blog/${data.imgurlki}`} alt={data.titletaki} />
            ...
            <Link href={`/blogs/${data.posotid}`} className="uppercase py-4 px-8 bg-orange-600 hover:bg-blue-900 text-white font-bold rounded-md">read more</Link>
        </div>
    )
}
